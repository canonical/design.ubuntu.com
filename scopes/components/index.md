...
<div class="row">
  ...
  <ul class="col-6 list"><li><a href="#scope-header">Scope header&nbsp;&rsaquo;</a></li><li><a href="#categories">Categories&nbsp;&rsaquo;</a></li><li><a href="#cards">Cards&nbsp;&rsaquo;</a></li></ul>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-6 combined-list">
  <ul class="col-6 list"><li><a href="#scope-title">Scope title&nbsp;&rsaquo;</a></li><li><a href="#placing-actions">Placing actions&nbsp;&rsaquo;</a></li><li><a href="#header-search">Header search&nbsp;&rsaquo;</a></li></ul>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}6dbb7d61-Scope-title-1-1024x179.png" alt="Scope title 1" width="1024" height="179">
  <p></p>
  <h3>Text: Scope title</h3>
</div>
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}b18881d5-Scope-title-2-1024x179.png" alt="Scope title 2" width="1024" height="179">
  <p></p>
...
<div class="row">
  ...
  <div class="col-8">
  <img class="alignnone size-large" src="{{ site.assets_path }}4008e9d9-Scope-header-nav-1024x179.png" alt="Scope header nav" width="1024" height="179">
</div>
  <div class="col-8">
  <h3>Actions</h3>
  ...
  <div class="col-8">
  <img class="alignnone size-large" src="{{ site.assets_path }}c29fc303-placing-actions-22-1024x179.png" alt="placing actions 2" width="1024" height="179">
</div>
  <div class="col-8">
  <h3>Burger menu</h3>
...
<div class="row">
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}87a4ff83-Header-search-12-618x1024.png" alt="Header search 1" width="618" height="1024">
</div>
  <h3>Search icon</h3>
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}047480d2-Header-search-22-618x1024.png" alt="Header search 2" width="618" height="1024">
</div>
  <h3>Suggestions</h3>
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}2799a9c0-Header-search-32-618x1024.png" alt="Header search 3" width="618" height="1024">
</div>
  <h3>Results page</h3>
...
<div class="row">
  ...
  <p><img class="alignnone size-large" src="{{ site.assets_path }}4d85b0ab-Structure-11-722x1024.png" alt="Structure (1)" width="722" height="1024"></p>
</div>
  <div class="col-8">
...
<div class="row">
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}abe9c898-Category-header-Header-less-1024x538.png" alt="Category header (Header-less)" width="1024" height="538">
</div>
  <h3>No header</h3>
...
<div class="row">
  ...
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}13ea4bb0-Header-link-12-618x1024.png" alt="Header link 1" width="618" height="1024">
</div>
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}7794773a-Header-link-21-618x1024.png" alt="Header link 2" width="618" height="1024">
</div>
  <div class="col-6 box box-grey">
  <div class="col-1 align-centre">
...
<div class="row">
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}24e0ebe2-Card-size-4-1024x693.png" alt="Card size 4" width="1024" height="693">
</div>
  <h3>Grid</h3>
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}d6a21b64-Card-size-5-1024x693.png" alt="Card size 5" width="1024" height="693">
</div>
...
<div class="row">
  ...
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}6002b078-Category-Expansion-1-618x1024.png" alt="Category Expansion 1" width="618" height="1024">
</div>
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}27bd3678-Category-Expansion-2-618x1024.png" alt="Category Expansion 2" width="618" height="1024">
</div>
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}5af46eaf-Category-Expansion-3-618x1024.png" alt="Category Expansion 3" width="618" height="1024">
</div>
  <div class="col-4">
...
<div class="row">
  ...
  <div class="col-8">
  <img class="alignnone size-full" src="{{ site.assets_path }}d2174751-card-components2.png" alt="card components" width="1023" height="798">
</div>
</div>
...
<div class="row">
  ...
  <div class="append-four col-8 box box-grey">
  <div class="col-1 align-centre">
  <img class="alignnone size-full" src="{{ site.assets_path }}7024ba0f-information-link.png" alt="information-link" width="32" height="32">
</div>
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}56a33d9c-Card-art-1-2-1.png" alt="Card art 1-2 (1)" width="622" height="361">
</div>
  <h4>1.2</h4>
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}e92f38bb-Card-art-1-3-1.png" alt="Card art 1-3 (1)" width="528" height="261">
</div>
  <h4>1.3</h4>
  <p></p>
  ...
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}3147fdb2-Art-and-mask-11.png" alt="Art and mask 1" width="537" height="568">
</div>
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}90384075-Art-and-mask-2.png" alt="Art and mask 2" width="537" height="568">
</div>
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}44372687-Art-and-mask-3.png" alt="Art and mask 3" width="537" height="568">
</div>
  <div class="col-8">
...
<div class="row">
  ...
  <div class="col-8">
  <img class="alignnone size-full" src="{{ site.assets_path }}8171d661-Card-header1.png" alt="Card header" width="970" height="271">
</div>
</div>
  <div class="col-8">
  <h3>Elements</h3>
...
<div class="row">
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}4bcc755a-atribute-price1.png" alt="atribute price" width="456" height="266">
</div>
  <h3>Price</h3>
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}74a80fc6-atribute-rating1.png" alt="atribute rating" width="456" height="266">
</div>
  <h3>Rating</h3>
  <p>Is a text string with a predefined star icon.</p>
</div>
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-full" src="{{ site.assets_path }}a57af743-atribute-scale1.png" alt="atribute scale" width="456" height="266">
</div>
  <h3>Scale</h3>
...
<div class="row">
  ...
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}fd53e522-Placement-1-atribute-landscape.png" alt="Placement 1 atribute landscape" width="970" height="271">
</div>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}e43fe443-Placement-1-atribute.png" alt="Placement 1 atribute" width="970" height="271">
</div>
  <div class="col-12">
  <h3>2\. attributes</h3>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}6cf37138-Placement-2-atribute-.png" alt="Placement 2 atribute" width="970" height="271">
</div>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}02607578-Placement-2-attributes-landscape-.png" alt="Placement 2 attributes landscape" width="898" height="692">
</div>
  <div class="col-12">
  <h3>3\. attributes</h3>
</div>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}6b72a0e5-Placement-2-atribute-landscape-copy.png" alt="Placement 2 atribute landscape copy" width="970" height="271">
</div>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}359babad-Placement-3-atribute-.png" alt="Placement 3 atribute" width="970" height="271">
</div>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-8">The header will have a dark overlay and the text will be white.</div>
  <div class="col-8 box box-grey">
  <div class="col-1 align-centre">
  <img class="alignnone size-full" src="{{ site.assets_path }}7024ba0f-information-link.png" alt="information-link" width="32" height="32">
</div>
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}af1a2bf4-header-text-1.png" alt="header text 1" width="971" height="271">
</div>
  <h4>1</h4>
</div>
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}df517f05-header-text-2.png" alt="header text 2" width="970" height="271">
</div>
  <h4>2</h4>
</div>
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}beabcdcf-header-text-3.png" alt="header text 3" width="971" height="271">
</div>
  <h4>3</h4>
</div>
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}c75cad8a-header-text-4.png" alt="header text 4" width="970" height="271">
</div>
  <h4>4</h4>
</div>
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}2e6d7b35-header-text-6.png" alt="header text 6" width="970" height="271">
</div>
  <h4>5</h4>
</div>
  <table>
...
<div class="row">
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}679b7421-Card-size-1-1024x537.png" alt="Card size 1" width="1024" height="537">
</div>
  <h3>Large</h3>
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}ec5c4254-Card-size-2-1024x537.png" alt="Card size 2" width="1024" height="537">
</div>
  <h3>Medium</h3>
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}51eaa5db-Card-size-3-1024x537.png" alt="Card size 3" width="1024" height="537">
</div>
  <h3>Small</h3>
...
<div class="row">
  ...
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}02804161-Card-design-horizontal-header-1.png" alt="Card design horizontal header 1" width="970" height="271">
</div>
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}e808b305-Card-design-horizontal-header-2.png" alt="Card design horizontal header 2" width="970" height="350">
</div>
</div>
  <div class="col-6">
...
<div class="row no-border">
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-large" src="{{ site.assets_path }}1eeb84a0-Placing-components-2-1024x855.png" alt="Placing components 2" width="1024" height="855">
</div>
  ...
  <div class="col-6">
  <div class="col-6">
  <img class="alignnone size-full" src="{{ site.assets_path }}b9322b6f-Placing-components-1.png" alt="Placing components 1" width="953" height="805">
</div>
