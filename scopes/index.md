...
<div class="row">
  ...
  <ul class="list col-6"><li><a href="#how-they-work">How they work&nbsp;&rsaquo;</a></li><li><a href="#the-benefit-of-scopes">The benefit of Scopes&nbsp;&rsaquo;</a></li><li><a href="#easy-to-create">Easy to create&nbsp;&rsaquo;</a></li></ul>
  <ul class="list col-6"><li><a href="#scope-types">Scope types&nbsp;&rsaquo;</a></li><li><a href="#launch-scopes">Launch scopes&nbsp;&rsaquo;</a></li><li><a href="#start-designing">Start designing&nbsp;&rsaquo;</a></li></ul>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-8">
  <img class="alignnone size-large" src="{{ site.assets_path }}f993130b-diagram-1-1024x764.png" alt="diagram (1)" width="1024" height="764">
</div>
  <div class="col-8">
...
<div class="row">
  ...
  <img class="alignnone size-large" src="{{ site.assets_path }}bd82cf6c-nearby-1.png" alt="nearby-1 (1)" width="567" height="1024">
</div>
</div>
  <div class="col-12 equal-heights">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}805b6583-Timeout_2.png" alt="Timeout_2" width="567" height="1024">
</div>
  ...
  <div class="col-4 prefix-1">
  <img class="alignnone size-large" src="{{ site.assets_path }}b176388d-timeout_1.png" alt="timeout_1" width="567" height="1024">
</div>
</div>
  <div class="col-8 box box-grey">
  <div class="col-1 align-center">
...
<div class="row">
  ...
  <div class="col-4 combined-list">
  <ul class="col-4 list"><li><a href="#cards">Cards&nbsp;&rsaquo;</a></li><li><a href="#categories">Categories&nbsp;&rsaquo;</a></li><li><a href="#modes-of-display">Modes of display&nbsp;&rsaquo;</a></li></ul>
</div>
</div>
...
<div class="row">
  ...
  <p><img class="alignnone size-full" src="{{ site.assets_path }}d2174751-card-components2.png" alt="card components" width="1023" height="798"></p>
...
<div class="row">
  ...
  <div class="col-6">
  <p><img class="alignnone size-large" src="{{ site.assets_path }}24e0ebe2-Card-size-4-1024x693.png" alt="Card size 4" width="1024" height="693"></p>
  <h3>Grid</h3>
</div>
  <div class="col-6">
  <p><img class="alignnone size-large" src="{{ site.assets_path }}d6a21b64-Card-size-5-1024x693.png" alt="Card size 5" width="1024" height="693"></p>
...
<div class="row">
  ...
  <div class="col-12 equal-heights">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}9ca20510-search_in_scope.png" alt="search_in_scope" width="567" height="1024">
</div>
  <div class="col-6 prefix-1">
  <div class="vertical-align">
  <h3>Search mode</h3>
...
<div class="row">
  ...
  <div class="col-12 equal-heights">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}ff3a2385-today_1.png" alt="today" width="567" height="1024">
</div>
  ...
  <div class="col-4 prefix-1">
  <img class="alignnone size-large" src="{{ site.assets_path }}206e338c-bbc-news1.png" alt="bbc-news1" width="567" height="1024">
</div>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-4">
  <div class="col-4">
  <img class="alignnone size-large" src="{{ site.assets_path }}64e7c610-apps.png" alt="apps (1)" width="567" height="1024">
</div>
  <h3>Apps</h3>
...
<div class="row no-border">
  ...
  <p><img class="alignnone size-large" src="{{ site.assets_path }}0e4bc1fd-1.Grid_40-1024x730.png" alt="1.Grid_40" width="1024" height="730"></p>
  <h4>Available:</h4>
  ...
  <div class="col-12">
  <div class="col-6 box box-grey">
  <div class="col-1 align-center" style="margin-bottom: 50px;">
  <img class="alignnone size-full" src="{{ site.assets_path }}7024ba0f-information-link.png" alt="information-link" width="32" height="32">
</div>
  ...
  <div class="col-8 box box-grey">
  <div class="col-1 align-center" style="margin-bottom: 0px;">
  <img class="alignnone size-full" src="{{ site.assets_path }}0d9d7281-developer_links..png" alt="developer_links." width="32" height="32">
</div>
