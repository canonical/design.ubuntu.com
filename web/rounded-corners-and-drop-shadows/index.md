...
<div id="attachment_1156" style="width: 485px" class="wp-caption alignnone"><img src="/assets/images/web-rounded-corners-dropshadow.png" alt="Web - Rounded corners and drop-shadow" title="Web - Rounded corners and drop-shadow" width="475" height="176" class="size-full wp-image-1156" srcset="http://design.ubuntu.com//assets/images/web-rounded-corners-dropshadow.png 475w, http://design.ubuntu.com//assets/images/web-rounded-corners-dropshadow-300x111.png 300w" sizes="(max-width: 475px) 100vw, 475px" /><p class="wp-caption-text">Figure 1: A box on ubuntu.com with rounded corners and drop-shadow</p></div>
