...
<h2>Labels</h2>
<p><img src="/assets/images/ubuntu-guidelines-web-forms-labels.gif" alt="Web guidelines - Form labels" title="Web guidelines - Form labels" width="540" height="124" class="alignnone size-full wp-image-361" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels-300x68.gif 300w" sizes="(max-width: 540px) 100vw, 540px" /></p>
<ul>
...
<p><img src="/assets/images/ubuntu-guidelines-web-forms-labels-left.gif" alt="Web guidelines - Forms labels aligned left" title="Web guidelines - Forms labels aligned left" width="540" height="106" class="alignnone size-full wp-image-362" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels-left.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels-left-300x58.gif 300w" sizes="(max-width: 540px) 100vw, 540px" /></p>
<div class="wp-link-top clearfix"><a href="forms#">top</a></div>
<h2>Input fields</h2>
<p><img src="/assets/images/ubuntu-guidelines-web-forms-labels.gif" alt="Web guidelines - Form labels" title="Web guidelines - Form labels" width="540" height="124" class="alignnone size-full wp-image-361" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-labels-300x68.gif 300w" sizes="(max-width: 540px) 100vw, 540px" /></p>
...
<p>Each combination of label/input field should have a bottom margin of 14px. If you&#8217;re using an ordered list to mark up your list, you may use or adapt the following style:</p>
<pre>form > ol > li {
margin-bottom: 14px;
}</pre>
<div class="wp-link-top clearfix"><a href="forms#">top</a></div>
...
<p><img src="/assets/images/ubuntu-guidelines-web-forms-input-types.gif" alt="Web guidelines - Input types" title="Web guidelines - Input types" width="540" height="77" class="alignnone size-full wp-image-363" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-input-types.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-input-types-300x42.gif 300w" sizes="(max-width: 540px) 100vw, 540px" /></p>
...
<div id="attachment_1051" style="width: 486px" class="wp-caption alignnone"><img src="/assets/images/web-forms-buttons-default.png" alt="Web guidelines - Buttons default positioning" title="Web guidelines - Buttons default positioning" width="476" height="109" class="size-full wp-image-1051" srcset="http://design.ubuntu.com//assets/images/web-forms-buttons-default.png 476w, http://design.ubuntu.com//assets/images/web-forms-buttons-default-300x68.png 300w" sizes="(max-width: 476px) 100vw, 476px" /><p class="wp-caption-text">Buttons: Default positioning</p></div>
...
<p><img src="/assets/images/ubuntu-guidelines-web-forms-notes.gif" alt="Web guidelines - Form notes" title="Web guidelines - Form notes" width="540" height="64" class="alignnone size-full wp-image-367" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-notes.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-notes-300x35.gif 300w" sizes="(max-width: 540px) 100vw, 540px" /></p>
<div class="wp-link-top clearfix"><a href="forms#">top</a></div>
<h2>Fieldsets</h2>
...
<p><img src="/assets/images/ubuntu-guidelines-web-forms-fieldsets.gif" alt="Web guidelines - Form fieldsets" title="Web guidelines - Form fieldsets" width="540" height="607" class="alignnone size-full wp-image-368" srcset="http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-fieldsets.gif 540w, http://design.ubuntu.com//assets/images/ubuntu-guidelines-web-forms-fieldsets-266x300.gif 266w" sizes="(max-width: 540px) 100vw, 540px" /></p>
